it's a simple stopwatch compiled by python2.7,pythonQt4,runned in 64bit system.

indclude several functions listed as follows:

1.functions of stopwatch,including begin,stop,reset,quit.
